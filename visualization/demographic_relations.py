...
from const import OUTPUT_DIR, MIGRATION_PAL
...
def plot_circular_migration_bee_research(df):
    ...
    R_BASE    = R_outer + 0.08
    R_STEP    = 0.15
    MIN_GAP   = np.deg2rad(9)   # minimum angular separation
    ...
    fig.write_image(OUTPUT_DIR / "circular_migration_bee_research.png", scale=2)
    fig.write_image(OUTPUT_DIR / "circular_migration_bee_research.pdf", scale=2)